...
export default function FormPesanan({ onTambah }) {
  ...
  const tambahItem = () => {
    ...
    if (!produk || !jumlah || Number.isNaN(jumlahAngka) || jumlahAngka <= 0) {
    ...
    const itemBaru = {
      produk,
      jumlah: jumlahAngka,
      total: hargaProduk[produk] * jumlahAngka,
    };
  ...
  const currentTotal =
    produk && jumlah && !Number.isNaN(parseInt(jumlah, 10))
      ? hargaProduk[produk] * parseInt(jumlah, 10)
      : 0;
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Picker.Item label="Burnt Cheesecake" value="Burnt Cheesecake" />
        <Picker.Item label="Brownies" value="Brownies" />
        <Picker.Item label="Goguma Ppang" value="Goguma Ppang" />
        <Picker.Item label="Tiramisu" value="Tiramisu" />
        <Picker.Item label="Matcha Tart" value="Matcha Tart" />
      </Picker>
